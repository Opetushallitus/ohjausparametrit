...
COMMENT ON COLUMN siirtotiedosto.window_start IS 'Siirtotiedosto-operaation aikaikkunan alkuaika (siirtotiedostoon tulevat tällä aikavälillä muuttuneet ohjausparametrit)';
COMMENT ON COLUMN siirtotiedosto.window_end IS 'Siirtotiedosto-operaation aikaikkunan loppuaika (siirtotiedostoon tulevat tällä aikavälillä muuttuneet ohjausparametrit)';
...
VALUES (nextval('siirtotiedosto_id_seq'), '57be2612-ba79-429e-a93e-c38346f1d62d', '1970-01-01 00:00:00.000000 +00:00', '2024-08-01 00:00:00.000000 +00:00', now(), now(), '{}'::jsonb, true, null) ON CONFLICT DO NOTHING;
